    ...
    <article className="flex flex-col items-start justify-center gap-8 text-gray-700 dark:text-gray-300 md:flex-row">
      <div className="text-base [&>p]:mb-4 [&>p>strong]:text-emerald-700 dark:[&>p>strong]:text-emerald-300 [&>p>strong]:font-normal [&>p>strong]:font-mono text-pretty order-2 md:order-1">
        ...
        <p>
          ...
          <strong>React, Node.js, expressJS y MongoDB</strong>.
        </p>
        <p>
          Me interesan los proyectos que me permiten desarrollar habilidades de liderazgo, trabajo en
          equipo y responsabilidad social.
        </p>
      </div>

      <img
        src="https://images.unsplash.com/photo-1508830524289-0adcbe822b40?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHByb2dyYW1hZG9yfGVufDB8fDB8fHww"
